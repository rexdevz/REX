...
git clone https://github.com/shinigami46/local_manifest --depth 1 -b banana-12 .repo/local_manifests
...
m banana -j10  > reading & sleep 95m # Jangan di hapus text line (> reading)
