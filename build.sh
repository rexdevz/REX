...
git clone https://github.com/rexdevz/local_manifest --depth 1 -b lineage-20 .repo/local_manifests
...
mka bacon -j10 > reading & sleep 95m # Jangan di hapus text line (> reading)
