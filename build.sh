...
git clone https://github.com/rexdevz/local_manifest --depth 1 -b evo-11 .repo/local_manifests
...
mka evolution > reading & sleep 95m # Jangan di hapus text line (> reading)
